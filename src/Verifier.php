...
/**
 * Password Verifier Class.
 */
class Verifier
{
    private $checkMinLength = false;
    private $checkMaxLength = false;
    private $checkLetters = false;
    private $checkCapitals = false;
    private $checkNumbers = false;
    private $checkSpecialChrs = false;
    private $checkBlacklist = false;
    ...
    public function checkPassword($password)
    {
        ...
        if ($this->checkBlacklist) {
            $filename = dirname(dirname(__FILE__)).'/assets/top_10000_passwords.txt';
    ...
    public function setMaxLength($length)
    {
        ...
        } elseif ($length && $length < $this->checkMinLength) {
